      ...
      >
        <form onSubmit={handleSubmit} className="flex flex-col gap-5 text-xl">
          ...
          <div className="flex justify-center items-center mx-auto w-full gap-2">
            <button
              type="submit"
              className="flex-1 flex justify-center items-center bg-slate-100 hover:bg-slate-200 duration-200 transition rounded-lg shadow-lg p-2 text-3xl text-green-600"
            >
              <AiOutlinePlusCircle />
            </button>
            <button
